...
<!--blog-section-->
      <div class="blog-section">
		<div class="container">
		  <h3 class="single">Hamane Health</h3>
		   <div class="blog-top">
					...
					<div class="single-img">
					 <a href="#">
					  <img src="../assets/images/bottom.jpg" alt="">
                        ...
                        <h3 class="wow slideInUp"  data-wow-duration="1s" data-wow-delay=".3s">Health education and counselling of persons affected by HIV/AIDs.
Training to VHTs on phychosocial support and counselling.</h3>
					   ...
					   <p Class="wow slideInUp" data-wow-duration="1s" data-wow-delay=".3s">
					   		In our effort to improve on the health service delivery and the general health of the people in Northern Uganda, HAM will conduct these activities;
							   <br />
							<ul style="text-indent: 2em;">
								<li>Empower and build capacity of Health centre personnel (Clinical officers, Enrolled comprehensive nurse, counsellors, midwives and health management committee).</li>
								<li>Mobilize and sensitize the community on basic public health practices including sanitation and nutrition.</li>
								<li>Voluntary counselling and HIV testing.</li>
								<li>Training and empowering Village Health teams on psychosocial support, behavioral change communication and counselling.</li>
								<li>Provision of non-financial items to families/homes affected by HIV/AIDs, nodding syndrome and other chronic diseases.</li>
								<li>Facilitate referrals of severe cases of nodding syndrome and other medical conditions from the health centers to referral hospitals.</li>
							</ul>
					   </p>				                     
				</div>
