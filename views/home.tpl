						...
						<li>
						   <div class="banner-info">
								  ...
								  <p class="wow slideInDown"  data-wow-duration="1s" data-wow-delay=".3s">TAKE A TOUR</p>
								   <div class="arrows wow slideInDown"  data-wow-duration="1s" data-wow-delay=".2s"><img src="../assets/images/border.png" alt="border"/></div>
			  ...
			  <!--/about-section2-->
			   <div class="about-section">
				  ...
				  <div class="grid">
					...
					<figure class="effect-jazz">
					<img src="../assets/images/s4.jpg" alt="img25"/>
						<figcaption>
							<h4>humane <span>africa</span></h4>
							<p>When Jazz starts to chase cars, the whole world stands still.</p>
				 ...
				 <div class="h-f  wow slideInRight"  data-wow-duration="1s" data-wow-delay=".2s">
					<figure class="effect-jazz">
						<img src="../assets/images/s3.jpg" alt="img25"/>
						<figcaption>
							<h4>humane <span>africa</span></h4>
							<p>When Jazz starts to chase cars, the whole world stands still.</p>
	...
	<div id="review" class="reviews">
			   <div class="col-md-6 test-left-img">
				...
				<div class="col-md-6 test-monials">
					...
					<div class="arrows-serve test"><img src="../assets/images/border.png" alt="border"></div>
				<!--//screen-gallery-->
						       ...
						       <div id="owl-demo" class="owl-carousel">
					                 <div class="item-owl">
					                		<div class="test-review">
											   <p class="wow fadeInUp"  data-wow-duration=".8s" data-wow-delay=".4s"><img src="../assets/images/left-quotes.png" alt=""> Consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. <img src="../assets/images/right-quotes.png" alt=""></p>
					                 ...
					                 <div class="item-owl">
					                	<div class="test-review">
										 <p class="wow fadeInUp"  data-wow-duration=".8s" data-wow-delay=".4s"> <img src="../assets/images/left-quotes.png" alt="">Polite sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.<img src="../assets/images/right-quotes.png" alt=""></p>
